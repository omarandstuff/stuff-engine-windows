...
void GEView::render()
{
	...
	glm::mat4 matrix = glm::perspective(glm::radians(45.0f), float(Width) / float(Height), 0.1f, 1000.0f) * glm::lookAt(glm::vec3(0.0f, 90.0f, 120.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
